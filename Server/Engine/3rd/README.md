...
- Internal aliases `de::thirdparty::spdlog`, `de::thirdparty::zeromq`,
  `de::thirdparty::asio`, `de::thirdparty::nlohmann_json`,
  `de::thirdparty::kcp`, and `de::thirdparty::nethost` shield project code
  from upstream target naming or directory layout details.
- `de::thirdparty::asio` sets `ASIO_STANDALONE=1` and links required threading
